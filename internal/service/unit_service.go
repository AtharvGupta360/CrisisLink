...
var validUnitStatuses = map[string]bool{
	models.UnitAvailable:    true,
	models.UnitReserved:     true,
	models.UnitEnRoute:      true,
	models.UnitOnScene:      true,
	models.UnitOutOfService: true,
}
...
func (s *UnitService) GetByID(ctx context.Context, id string) (*models.Unit, error) {
...
func (s *UnitService) List(ctx context.Context, status, unitType string, limit, offset int) ([]models.Unit, error) {
...
func (s *UnitService) UpdateStatus(ctx context.Context, id, status string) (*models.Unit, error) {
