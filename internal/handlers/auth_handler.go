// Package handlers is the HTTP layer: each handler validates input, calls a
// service, and writes the response envelope. Handlers hold NO business logic and
// touch NO database directly — they depend only on services.
package handlers
